 ...
 */
fun myProfile() {
    val firstName: String = "Farida"
    val lastName: String = "Afrina"
    val age: Int = 20
 ...
 */
fun myTeam(): List<Any> {
    val groupMembers = listOf( "Astriani",
        "Farida" ,
        "Fadillah",
        "Shofiyya",
        "Taufiq")
...
fun totalMember(): Int {
    ...
    val countOfGroup = arrayOf<String>("Astriani","Farida", "Fadillah", "Shofiyya",  "Taufiq")
...
fun main() {
     ...
     */
//    groupDetail("", listOf(), "")
    groupDetail("Strix", listOf("Astriani","Farida", "Fadillah", "Shofiyya",  "Taufiq"), "Afternoon")
